...
export function MonthlyTrendChart({ stats }: MonthlyTrendChartProps) {
  if (stats.monthlyTrend.length === 0) {
    return (
      <Card className="p-6">
        ...
        <p className="text-muted-foreground text-center py-8">No hay datos suficientes para mostrar la tendencia</p>
      </Card>
    )
  }
  ...
  return (
    <Card className="p-6">
      <h3 className="text-lg font-semibold mb-4">Tendencia mensual (últimos 6 meses)</h3>
