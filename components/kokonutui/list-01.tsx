              ...
              <div className="flex items-center gap-2">
                <div
                  className={cn("p-1.5 rounded-lg", {
                    "bg-success/10": account.type === "savings",
                    "bg-primary/10": account.type === "checking",
                    "bg-secondary/10": account.type === "investment",
                  })}
                >
                  {account.type === "savings" && (
                    <Wallet className="w-3.5 h-3.5 text-success" />
                  )}
                  {account.type === "checking" && <QrCode className="w-3.5 h-3.5 text-primary" />}
